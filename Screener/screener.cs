    ...
    public static class Screener
    {
            ...
            object proxy = null)
        {
            ...
            if (query is string queryStr)
            {
                ...
                var resp = _data.Get(url: Consts.PREDEFINED_URL, parameters: paramsDict);
            ...
            // Fetch
            var response = _data.Post(Consts.SCREENER_URL, body: postQuery, parameters: paramsDict);
