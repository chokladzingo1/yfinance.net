...
namespace yfinance.screener
{
    public abstract class QueryBase
    {
        ...
        public abstract Dictionary<string, HashSet<string>> ValidFields { get; }
    ...
    public class EquityQuery : QueryBase
    {
        ...
        public override Dictionary<string, HashSet<string>> ValidFields => Consts.EQUITY_SCREENER_FIELDS;
    ...
    public class FundQuery : QueryBase
    {
        ...
        public override Dictionary<string, HashSet<string>> ValidFields => Consts.FUND_SCREENER_FIELDS;
