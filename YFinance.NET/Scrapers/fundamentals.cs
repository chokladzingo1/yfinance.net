...
namespace yfinance.scrapers
{
    public class Fundamentals
    {
        ...
        public Fundamentals(YfData data, string symbol, IWebProxy proxy = null)
        {
    ...
    public class Financials
    {
        ...
        public DataTable GetIncomeTimeSeries(string freq = "yearly", IWebProxy proxy = null)
        {
            if (proxy != null && !proxy.Equals(Consts.SENTINEL))
            {
                Debug.WriteLine("Set proxy via new config function: yf.set_config(proxy=proxy)");
        ...
        public DataTable GetBalanceSheetTimeSeries(string freq = "yearly", IWebProxy proxy = null)
        {
            if (proxy != null && !proxy.Equals(Consts.SENTINEL))
            {
                Debug.WriteLine("Set proxy via new config function: yf.set_config(proxy=proxy)");
        ...
        public DataTable GetCashFlowTimeSeries(string freq = "yearly", IWebProxy proxy = null)
        {
            if (proxy != null && !proxy.Equals(Consts.SENTINEL))
            {
                Debug.WriteLine("Set proxy via new config function: yf.set_config(proxy=proxy)");
        ...
        private DataTable CreateFinancialsTable(string name, string timescale)
        {
            ...
            var keys = Consts.FUNDAMENTALS_KEYS[internalName];
        ...
        private DataTable GetFinancialsTimeSeries(string timescale, List<string> keys)
        {
            ...
            string jsonStr = string.Empty;//_data.CacheGet(url: url).Result;
